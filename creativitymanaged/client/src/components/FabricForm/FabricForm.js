			...
			<form>
				<div>
					<div className="form-group" id="fabric_name">
						<label for="exampleFormControlInput1">Fabric Name</label>
					...
					<div className="form-group" id="fabric_type">
						<label for="exampleFormControlInput1">Fabric Type</label>
					...
					<div className="form-group" id="fabric_yardage">
						<label for="exampleFormControlInput1">Fabric Yardage</label>
					...
					<div className="form-group" id="pattern_sizes">
						<label for="exampleFormControlTextarea1">Fabric Washing Instructions</label>
					...
					<div className="form-group" id="fabric_picture">
						<label for="exampleFormControlFile1" id="picture_head">Fabric Picture</label>
